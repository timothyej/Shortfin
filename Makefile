...
pkgdatadir = $(datadir)/shortfin
pkgincludedir = $(includedir)/shortfin
pkglibdir = $(libdir)/shortfin
pkglibexecdir = $(libexecdir)/shortfin
...
am_shortfin_OBJECTS = src/master_server.$(OBJEXT) src/server.$(OBJEXT) \
	src/safe.$(OBJEXT) src/worker.$(OBJEXT) src/socket.$(OBJEXT) \
	src/cache.$(OBJEXT) src/request.$(OBJEXT) \
...
SOURCES = $(shortfin_SOURCES)
DIST_SOURCES = $(shortfin_SOURCES)
ETAGS = etags
CTAGS = ctags
...
PACKAGE = shortfin
PACKAGE_BUGREPORT = 
PACKAGE_NAME = shortfin
PACKAGE_STRING = shortfin 1.0
PACKAGE_TARNAME = shortfin
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
SET_MAKE = 
...
src/connection.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/status_codes.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
src/mime_types.$(OBJEXT): src/$(am__dirstamp) \
	src/$(DEPDIR)/$(am__dirstamp)
...
include src/$(DEPDIR)/status_codes.Po
